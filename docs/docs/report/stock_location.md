...
View the [source code](https://github.com/inventree/InvenTree/blob/master/InvenTree/report/templates/slr/inventree_slr_report_base.html) for the default stock location report template.
