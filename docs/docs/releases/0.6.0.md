...
If you are as excited as we are [set up your own instance](https://inventree.readthedocs.io/en/latest/start), check out the [demo](https://inventree.readthedocs.io/en/latest/demo/) or browse the [documentation](https://inventree.readthedocs.io/en/latest/)!
