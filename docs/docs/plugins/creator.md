...
!!! warning "Minimum Version"
    The plugin creator tool is designed to develop plugins targeting InvenTree version 1.0.0 or later. In particular, user interface features generated with the plugin creator tool will not work with earlier versions of InvenTree.
