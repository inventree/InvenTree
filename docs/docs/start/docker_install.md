...
It is recommended to check the [thread modelling inputs](../concepts/thread_model.md) to ensure that your InvenTree installation is set up in the way that it is assumed in the software design.
