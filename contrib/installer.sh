...
installer_usage() {
  if [[ -n $long_usage ]]; then
    printf "installer - Installer for InvenTree\n"
    echo
  ...
  printf "Usage:\n"
  printf "  installer [SOURCE] [PUBLISHER] [OPTIONS]\n"
  printf "  installer --help | -h\n"
  ...
  if [[ -n $long_usage ]]; then
    ...
    printf "Examples:\n"
    printf "  installer\n"
    printf "  installer master --no-call\n"
    printf "  installer master matmair --dry-run\n"
    echo
