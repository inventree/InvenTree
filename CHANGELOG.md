...
- [#11793](https://github.com/inventree/InvenTree/pull/11793) adds a new global setting `PART_BOM_VALIDATE_GROUP`, which allows administrators to specify a group of users who are allowed to validate BOMs. If this setting is not set (default), any user with the appropriate permissions to edit the part will be able to validate the BOM.
