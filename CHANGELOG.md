...
- [#xxxx](https://github.com/inventree/InvenTree/pull/xxx) Tokens are now issued in the v2 format and might be longer. Old tokens continue to work but should be considered for rotation
