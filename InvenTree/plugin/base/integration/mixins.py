...
class APICallMixin:
    ...
    def api_call(self, endpoint: str, method: str = 'GET', url_args: dict = None, data: dict = None, json: dict = None, headers: dict = None, simple_response: bool = True, endpoint_is_url: bool = False):
        """Do an API call.
