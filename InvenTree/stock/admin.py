...
class LocationAdmin(ImportExportModelAdmin, GuardedModelAdmin):
...
class StockItemAdmin(ImportExportModelAdmin, GuardedModelAdmin):
...
class StockTrackingAdmin(ImportExportModelAdmin, GuardedModelAdmin):
