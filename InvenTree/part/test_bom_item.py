...
class BomItemTest(TestCase):
    ...
    def test_consumable(self):
        ...
        c1 = Part.objects.create(name="C1", description="Part C1")
        c2 = Part.objects.create(name="C2", description="Part C2")
        c3 = Part.objects.create(name="C3", description="Part C3")
        c4 = Part.objects.create(name="C4", description="Part C4")
