...
class PartFilter(rest_filters.FilterSet):
    ...
    def filter_low_stock(self, queryset, name, value):
        ...
        if str2bool(value):
            ...
            return queryset.exclude(
                ...
                Q(in_stock__lt=F('minimum_stock'))
            )
        else:
    ...
    def filter_convert_from(self, queryset, name, part):
        ...
        return queryset.filter(pk__in=conversion_options)
    ...
    complete_bom_pricing = rest_filters.BooleanFilter(label="Has complete BOM pricing", method="filter_has_complete_bom_pricing")

    def filter_has_complete_bom_pricing(self, queryset, name, value):
        """Filter the queryset based on whether the part has complete BOM pricing"""

        q_a = Q(pricing_data=None)
        q_b = Q(pricing_data__bom_cost_complete=False)
