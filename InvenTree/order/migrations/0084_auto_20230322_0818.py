    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('received_date', models.BooleanField(blank=True, help_text='The date this this return item was received', null=True, verbose_name='Received')),
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='return_order_lines', to='stock.stockitem', verbose_name='Stock Item')),
