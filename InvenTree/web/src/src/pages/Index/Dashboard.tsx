...
export function Dashboard() {
  ...
  const items = [
    ...
    {
      id: 'stock-to-build',
      text: 'Required for Build Orders',
      icon: 'fa-bullhorn',
      url: 'part',
