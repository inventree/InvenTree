...
export interface StatsElementProps {title: string; value: string;}

export function StatsElement({ key, data, isLoading }: {key: string, data: StatsElementProps, isLoading: boolean}) {
