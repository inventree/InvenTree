...
MFA_LOGIN_CALLBACK = ""
MFA_RECHECK = False
MFA_REDIRECT_AFTER_REGISTRATION = "index"
MFA_SUCCESS_REGISTRATION_MSG = _("Go to Security Home")
MFA_RECHECK_MIN = 10
MFA_RECHECK_MAX = 30
MFA_QUICKLOGIN = True
MFA_HIDE_DISABLE = ()

TOKEN_ISSUER_NAME = FIDO_SERVER_NAME = "PROJECT_NAME"
U2F_APPID = FIDO_SERVER_ID = "https://localhost"
