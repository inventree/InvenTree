"""
Custom management command to calculates translation coverage for various languages
"""
...
class Command(BaseCommand):
    """
    django command to calculates translation coverage for various languages
    """
    ...
    def handle(self, *args, **kwargs):
        ...
        verbose = kwargs.get('verbode', False)
