...
| Option | Description |
| --- | --- |
| [Server](/app/connect) | Select server profile and configure settings |
...
<Thumbnail src="/img/app/settings.png" title="Settings View" />

## App Settings

The *App Settings* view provides configuration options for the InvenTree app:

<Thumbnail src="/img/app/app_settings.png" title="App settings" />
...
The *Barcode Settings* view allows you to configure options relating to [barcode scanning](/app/barcode):

<Thumbnail src="/img/app/barcode_settings.png" title="Barcode settings" />
...
<Thumbnail src="/img/app/home_settings.png" title="Home settings" />
