...
If desired, users can disable error reporting entirely, from within the [app settings](/app/settings). This prevents any error logs from being uploaded to the sentry server.
:::
