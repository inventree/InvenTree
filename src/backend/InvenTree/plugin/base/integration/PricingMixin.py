...
class PricingMixin:
    ...
    def calculate_part_overall_price_range(
        ...
        raise MixinNotImplementedError(
            'calculate_part_overall_price_range not implemented'
        )
    ...
    def calculate_part_bom_price_range(self, part, *args, **kwargs) -> PriceRangeTuple:
        ...
        """
        raise MixinNotImplementedError('calculate_part_bom_price_range not implemented')
    ...
    def calculate_part_purchase_price_range(
        ...
        """
        raise MixinNotImplementedError(
            'calculate_part_purchase_price_range not implemented'
        )
    ...
    def calculate_part_supplier_price_range(
        ...
        """
        raise MixinNotImplementedError(
            'calculate_part_supplier_price_range not implemented'
        )
    ...
    def calculate_part_internal_price_range(
        ...
        """
        raise MixinNotImplementedError(
            'calculate_part_internal_price_range not implemented'
        )
    ...
    def calculate_part_variant_price_range(
        ...
        """
        raise MixinNotImplementedError(
            'calculate_part_variant_price_range not implemented'
        )
    ...
    def calculate_part_sale_price_range(self, part, *args, **kwargs) -> PriceRangeTuple:
        ...
        """
        raise MixinNotImplementedError(
            'calculate_part_sale_price_range not implemented'
        )
