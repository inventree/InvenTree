...
class RepairOrderSerializer(InvenTreeModelSerializer):
    """Serializer for the RepairOrder model."""
...
class RepairOrderLineItemSerializer(InvenTreeModelSerializer):
    """Serializer for the RepairOrderLineItem model."""
...
class RepairOrderAllocationSerializer(InvenTreeModelSerializer):
    """Serializer for the RepairOrderAllocation model."""
