...
class RepairOrderLineOutputOptions(OutputConfiguration):
    ...
    OPTIONS = [
        ...
        InvenTreeOutputOption('stock_item_detail', default=True),
        InvenTreeOutputOption('order_detail'),
    ]


class RepairOrderLineList(
    RepairOrderLineMixin, DataExportViewMixin, OutputOptionsMixin, ListCreateAPI
):
    ...
    ordering_field_aliases = {
        'line': ['line_int', 'line', 'part__name', 'stock_item__part__name'],
        'part': ['part__name', 'stock_item__part__name'],
        'IPN': ['part__IPN', 'stock_item__part__IPN'],
        'stock': ['stock_item__quantity', 'stock_item__serial_int', 'stock_item__serial'],
    }
        ...
        include([
            path(
                ...
                include([
                    ...
                    path(
                        'hold/',
                        RepairOrderHold.as_view(),
                        name='api-repair-order-hold',
                    ),
                    path(
                        'complete/',
