...
@admin.register(models.RepairOrderExtraLine)
class RepairOrderExtraLineAdmin(GeneralExtraLineAdmin, admin.ModelAdmin):
    """Admin class for the RepairOrderExtraLine model."""
