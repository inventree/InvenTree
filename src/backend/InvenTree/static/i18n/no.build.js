                ...
                formatter: function(value, row) {
                    ...
                    if (row.bom_item_detail.consumable) {
                        ...
                        if (available < (row.quantity - row.allocated)) {
                            icons += makeIconBadge('fa-times-circle icon-red', 'Utilstrekkelig lagerbeholdning');
                        } else {
                    ...
                    if (row.in_production && row.in_production > 0) {
                        icons += makeIconBadge('fa-tools icon-blue', `I produksjon: ${formatDecimal(row.in_production)}`);
                    }
