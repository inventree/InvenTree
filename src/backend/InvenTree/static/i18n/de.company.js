...
function deleteContacts(contacts, options={}) {
    ...
    let html = `
    <div class='alert alert-block alert-danger'>
    Alle ausgewählten Kontakte werden gelöscht
    </div>
    <table class='table table-striped table-condensed'>
    <tr>
        <th>Name</th>
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (options.allow_edit) {
                        html += makeEditButton('btn-contact-edit', pk, 'Kontakt bearbeiten');
                    }

                    if (options.allow_delete) {
                        html += makeDeleteButton('btn-contact-delete', pk, 'Kontakt löschen');
                    }
...
function deleteAddress(addresses, options={}) {
    ...
    let html = `
    <div class='alert alert-block alert-danger'>
    Alle ausgewählten Adressen werden gelöscht
    </div>
    <table class='table table-striped table-condensed'>
    <tr>
        <th>Name</th>
...
function loadAddressTable(table, options={}) {
    ...
    $(table).inventreeTable({
        ...
        sortable: true,
        formatNoMatches: function() {
            return 'Keine Adressen gefunden';
        },
        showColumns: true,
        name: 'addresses',
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (options.allow_edit) {
                        html += makeEditButton('btn-address-edit', pk, 'Adresse bearbeiten');
                    }

                    if (options.allow_delete) {
                        html += makeDeleteButton('btn-address-delete', pk, 'Adresse löschen');
                    }
...
function deleteManufacturerParts(selections, options={}) {
    ...
    var html = `
    <div class='alert alert-block alert-danger'>
    Alle ausgewählten Herstellerteile werden gelöscht
    </div>
    <table class='table table-striped table-condensed'>
    <tr>
        <th>Teil</th>
...
function loadSupplierPartTable(table, url, options) {
    ...
    $(table).inventreeTable({
        ...
        sortable: true,
        formatNoMatches: function() {
            return 'Keine Zulieferteile gefunden';
        },
        columns: [
            {
                checkbox: true,
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (row.part_detail && row.part_detail.units) {
                        html += `<span class='fas fa-info-circle float-right' title='Basiseinheit: ${row.part_detail.units}'></span>`;
                    }
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    html += makeEditButton('button-supplier-part-edit', pk, 'Zulieferteile bearbeiten');
                    html += makeDeleteButton('button-supplier-part-delete', pk, 'Zuliefererteil löschen');
...
function loadSupplierPriceBreakTable(options={}) {
    ...
    table.inventreeTable({
        ...
        formatNoMatches: function() {
            return 'Keine Staffelpreisinformation gefunden';
        },
        onPostBody: function() {
            setupCallbacks();
        },
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    buttons += makeEditButton('button-price-break-edit', row.pk, 'Staffelpreis bearbeiten');
                    buttons += makeDeleteButton('button-price-break-delete', row.pk, 'Staffelpreis löschen');
