...
function calculateTotalPrice(dataset, value_func, currency_func, options={}) {
    ...
    if (!rates) {
        ...
        return `<span class='icon-red fas fa-exclamation-circle' title='Pénznem adatok lekérdezése sikertelen'></span>`;
    }
...
function loadBomPricingChart(options={}) {
    ...
    table.inventreeTable({
        ...
        formatNoMatches: function() {
            return 'Nincs alkatrészjegyzék infomáció';
        },
...
function loadPartSupplierPricingTable(options={}) {
    ...
    table.inventreeTable({
        ...
        showColumns: false,
        formatNoMatches: function() {
            return 'Nincs beszállítói árinfomáció';
        },
        onLoadSuccess: function(data) {
            ...
            var graphLabels = Array.from(data, (x) => (`${x.part_detail.SKU} - Mennyiség ${x.quantity}`));
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    buttons += makeEditButton(`button-${name}-edit`, row.pk, `Szerkesztés ${human_name}`);
...
function loadPurchasePriceHistoryTable(options={}) {
    ...
    table.inventreeTable({
        ...
        showColumns: false,
        formatNoMatches: function() {
            return 'Nincsenek beszerzési ár előzmények';
        },
        onLoadSuccess: function(data) {
            ...
            chart = loadBarChart(chartElement, {
                ...
                datasets: [
                    {
                        label: 'Beszerzési ár előzmények',
                        data: graphValues,
                        backgroundColor: 'rgba(255, 206, 86, 0.2)',
                        borderColor: 'rgb(255, 206, 86)',
                        stepped: true,
...
function loadSalesPriceHistoryTable(options={}) {
    ...
    table.inventreeTable({
        ...
        showColumns: false,
        formatNoMatches: function() {
            return 'Nincsenek eladási ár előzmények';
        },
        onLoadSuccess: function(data) {
...
function loadVariantPricingChart(options={}) {
    ...
    table.inventreeTable({
        ...
        showColumns: false,
        formatNoMatches: function() {
            return 'Nincs alkatrészváltozat infomáció';
        },
        onLoadSuccess: function(data) {
