...
function deleteAddress(addresses, options={}) {
    ...
    let html = `
    <div class='alert alert-block alert-danger'>
    Todos las direcciones seleccionadas serán eliminadas
    </div>
    <table class='table table-striped table-condensed'>
    <tr>
        <th>Nombre</th>
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (options.allow_edit) {
                        html += makeEditButton('btn-address-edit', pk, 'Editar Dirección');
                    }

                    if (options.allow_delete) {
                        html += makeDeleteButton('btn-address-delete', pk, 'Eliminar Dirección');
                    }
        ...
        custom_actions: [
            {
                ...
                title: 'Acciones para partes del fabricante',
                icon: 'fa-tools',
...
function makeSupplierPartActions(options={}) {
    return [
        ...
        {
            label: 'delete',
            title: 'Eliminar piezas del proveedor',
            icon: 'fa-trash-alt icon-red',
            permission: 'purchase_order.delete',
            callback: function(data) {
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    html += makeEditButton('button-supplier-part-edit', pk, 'Editar parte del proveedor');
                    html += makeDeleteButton('button-supplier-part-delete', pk, 'Eliminar parte del proveedor');
