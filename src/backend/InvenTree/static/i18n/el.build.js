        ...
        preFormContent: function(opts) {
            ...
            if (ctx.allocated && ctx.remaining == 0 && ctx.incomplete == 0) {
                ...
                if (ctx.incomplete > 0) {
                    ...
                    <strong>Η παραγγελία κατασκευής έχει ελλιπή προϊόντα</strong><br>
                ...
                if (!ctx.allocated) {
                    html += `<div class='alert alert-block alert-warning'>Το απαιτούμενο απόθεμα δεν έχει δεσμευτεί πλήρως</div>`;
                }

                if (ctx.remaining > 0) {
                    html += `<div class='alert alert-block alert-warning'>Ο απαιτούμενος αριθμός προϊόντων δεν έχει ολοκληρωθεί</div>`;
                }
            }
