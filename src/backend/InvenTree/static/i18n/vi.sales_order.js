            ...
            if (!allocations || allocations.length == 0) {
                ...
                allocations.forEach(function(allocation) {
                    ...
                    if (allocation.serial) {
                        stock = `Số sê-ri: ${allocation.serial}`;
                    } else {
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row, index, field) {
                    ...
                    if (row.shipment_date) {
                        ...
                        // Location specified
                        return renderLink(
                            row.location_detail.pathstring || 'Địa điểm',
            ...
            },
            {
                ...
                formatter: function(value, row, index, field) {
                    ...
                    if (row.shipment_date) {
                        html += `<span class='badge bg-success badge-right'>Đã chuyển</span>`;
                    } else {
                ...
                formatter: function(value, row) {
                    ...
                    if (required > 0) {
                        if (available >= required) {
                            ...
                            html += makeIconBadge('fa-times-circle icon-red', 'Kho không đủ hạn mức khả dụng');
                        }
                    }
