...
function createManufacturerPart(options={}) {
    ...
    constructForm('/api/company/part/manufacturer/', {
        fields: fields,
        method: 'POST',
        title: 'Adicionar Peça do Fabricante',
...
function editManufacturerPart(part, options={}) {
    ...
    constructForm(url, {
        fields: fields,
        title: 'Editar Peça do Fabricante',
        onSuccess: options.onSuccess
    });
}
...
function createSupplierPart(options={}) {
    ...
    constructForm('/api/company/part/', {
        fields: fields,
        method: 'POST',
        title: 'Adicionar Peça do Fornecedor',
        onSuccess: options.onSuccess,
        header_html: header,
    });
}
...
function deleteSupplierParts(parts, options={}) {
    ...
    Todas as peças selecionadas do fornecedor serão apagadas
    </div>
...
function loadCompanyTable(table, url, options={}) {
    ...
    $(table).inventreeTable({
        ...
        formatNoMatches: function() {
            return 'Nenhuma informação da empresa encontrada';
        },
        showColumns: true,
...
function deleteContacts(contacts, options={}) {
    ...
    let html = `
    <div class='alert alert-block alert-danger'>
    Todos os contatos selecionados serão apagados
    </div>
    <table class='table table-striped table-condensed'>
    <tr>
        <th>Nome</th>
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (options.allow_edit) {
                        html += makeEditButton('btn-contact-edit', pk, 'Editar Contato');
                    }

                    if (options.allow_delete) {
                        html += makeDeleteButton('btn-contact-delete', pk, 'Excluir Contato');
                    }
...
function deleteAddress(addresses, options={}) {
    ...
    let html = `
    <div class='alert alert-block alert-danger'>
    Todos os endereços selecionados serão excluídos
    </div>
    <table class='table table-striped table-condensed'>
    <tr>
        <th>Nome</th>
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (options.allow_edit) {
                        html += makeEditButton('btn-address-edit', pk, 'Editar o Endereço');
                    }

                    if (options.allow_delete) {
                        html += makeDeleteButton('btn-address-delete', pk, 'Excluir Endereço');
                    }
...
function deleteManufacturerParts(selections, options={}) {
    ...
    var html = `
    <div class='alert alert-block alert-danger'>
    Todas as peças do fabricante selecionado serão excluídas
    </div>
    <table class='table table-striped table-condensed'>
    <tr>
        <th>Peça</th>
    ...
    constructForm('/api/company/part/manufacturer/', {
        method: 'DELETE',
        multi_delete: true,
        title: 'Excluir Peças do Fabricante',
        preFormContent: html,
        form_data: {
            items: ids,
        },
...
function deleteManufacturerPartParameters(selections, options={}) {
    ...
    var html = `
    <div class='alert alert-block alert-danger'>
    Todos os parâmetros selecionados serão excluídos
    </div>
    <table class='table table-striped table-condensed'>
    <tr>
        <th>Nome</th>
...
function loadManufacturerPartTable(table, url, options) {
        ...
        custom_actions: [
            {
                ...
                title: 'Ações de peça do fabricante',
                icon: 'fa-tools',
    ...
    $(table).inventreeTable({
        ...
        groupBy: false,
        formatNoMatches: function() {
            return 'Nenhuma peça do fabricante encontrada';
        },
        columns: [
            {
                checkbox: true,
...
function loadSupplierPartTable(table, url, options) {
    ...
    $(table).inventreeTable({
        ...
        sortable: true,
        formatNoMatches: function() {
            return 'Nenhum peça do fornecedor encontrada';
        },
        columns: [
            {
                checkbox: true,
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (row.part_detail && row.part_detail.units) {
                        html += `<span class='fas fa-info-circle float-right' title='Unidade Base: ${row.part_detail.units}'></span>`;
                    }
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    html += makeEditButton('button-supplier-part-edit', pk, 'Editar fornecedor da peça');
                    html += makeDeleteButton('button-supplier-part-delete', pk, 'Excluir peça do fornecedor');
...
function loadSupplierPriceBreakTable(options={}) {
    ...
    function setupCallbacks() {
        table.find('.button-price-break-delete').click(function() {
            ...
            constructForm(`/api/company/price-break/${pk}/`, {
                method: 'DELETE',
                title: 'Excluir quebras de preço',
                refreshTable: table,
            });
        });
    ...
    table.inventreeTable({
        ...
        formatNoMatches: function() {
            return 'Nenhuma informação de quebra de preço';
        },
        onPostBody: function() {
            setupCallbacks();
        },
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    buttons += makeEditButton('button-price-break-edit', row.pk, 'Editar quebra de preço');
                    buttons += makeDeleteButton('button-price-break-delete', row.pk, 'Excluir quebra de preço');
