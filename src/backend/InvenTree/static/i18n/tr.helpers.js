...
function editButton(url, text='Düzenle') {
...
function renderClipboard(s, prepend=false) {
    ...
    let clipString = `<span class="d-none d-xl-inline"><button class="btn clip-btn" type="button" data-bs-toggle='tooltip' title='panoya kopyala'><em class="fas fa-copy"></em></button></span>`;
