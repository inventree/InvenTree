...
function insertConfirmButton(options) {
    ...
    var message = options.confirmMessage || 'Confirma';
            ...
            const content = `
                <div class="mb-1">
                    <div class="input-group mb-2">
                        <input class="form-control" type="text" id="${name}_tree_search" placeholder="Caută ${options.actions[name].label}..." />
