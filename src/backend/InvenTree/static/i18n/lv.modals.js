...
function createNewModal(options={}) {
    ...
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>Iesniegt</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || 'Iesniegt');
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || 'Iesniegt';
    var close_text = options.close_text || 'Aizvērt';
