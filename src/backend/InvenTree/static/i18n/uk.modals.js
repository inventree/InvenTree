...
function createNewModal(options={}) {
    ...
    if (!options.hideCloseButton) {
        buttons += `<button type='button' class='btn btn-secondary' id='modal-form-close' data-bs-dismiss='modal'>Скасувати</button>`;
    }

    // Add in a "submit" button
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>Відправити</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || 'Відправити');
    modalSetCloseText(modal_name, options.closeText || 'Скасувати');
...
function showQuestionDialog(title, content, options={}) {
    ...
    options.closeText = options.cancel_text || 'Скасувати';
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || 'Відправити';
    var close_text = options.close_text || 'Закрити';
