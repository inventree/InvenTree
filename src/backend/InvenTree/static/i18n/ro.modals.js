...
function createNewModal(options={}) {
    ...
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>Trimite</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || 'Trimite');
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || 'Trimite';
    var close_text = options.close_text || 'Închide';
