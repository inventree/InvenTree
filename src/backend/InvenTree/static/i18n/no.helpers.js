...
function editButton(url, text='Rediger') {
...
function renderClipboard(s, prepend=false) {
    ...
    let clipString = `<span class="d-none d-xl-inline"><button class="btn clip-btn" type="button" data-bs-toggle='tooltip' title='kopier til utklippstavle'><em class="fas fa-copy"></em></button></span>`;
