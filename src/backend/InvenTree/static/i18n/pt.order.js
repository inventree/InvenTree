...
function createExtraLineItem(options={}) {
    ...
    constructForm(options.url, {
        fields: fields,
        method: 'POST',
        title: 'Adicionar Item de Linha Extra',
        onSuccess: function(response) {
            if (options.table) {
            ...
            },
            {
                ...
                formatter: function(value, row, index, field) {
                    ...
                    if (options.allow_edit || options.allow_delete) {
                        ...
                        if (options.allow_edit) {
                            html += makeCopyButton('button-duplicate', pk, 'Duplicar linha');
                            html += makeEditButton('button-edit', pk, 'Editar linha');
                        }

                        if (options.allow_delete) {
                            html += makeDeleteButton('button-delete', pk, 'Apagar linha', );
                        }
                    }
