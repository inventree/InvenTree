...
function exportBom(part_id, options={}) {
    ...
    constructFormBody({}, {
        ...
        fields: {
            ...
            cascade: {
                label: 'Mehrstufige Stückliste',
                help_text: 'Stücklistendaten für Untergruppen einbeziehen',
                type: 'boolean',
                value: inventreeLoad('bom-export-cascading', true),
            },
            levels: {
                label: 'Stufen',
                help_text: 'Wählen Sie die maximale Anzahl an zu exportierenden Stücklistenstufen (0 = alle Stufen)',
                type: 'integer',
                value: 0,
                required: true,
                min_value: 0,
            ...
            stock_data: {
                ...
                help_text: 'Teilebestand in exportierte Stückliste einbeziehen',
                type: 'boolean',
                value: inventreeLoad('bom-export-stock_data', false),
            },
            manufacturer_data: {
                label: 'Herstellerdaten einschließen',
                help_text: 'Teile-Herstellerdaten in Stückliste-Export einschließen',
                type: 'boolean',
                value: inventreeLoad('bom-export-manufacturer_data', false),
            },
            supplier_data: {
                label: 'Lieferantendaten einschließen',
                help_text: 'Teile-Bestand in Stückliste-Export einschließen',
                type: 'boolean',
                value: inventreeLoad('bom-export-supplier_data', false),
            },
            pricing_data: {
                label: 'Preisinformationen einschließen',
...
function bomSubstitutesDialog(bom_item_id, substitutes, options={}) {
    ...
    <div class='alert alert-success alert-block'>
        Wählen Sie ein neues Ersatzteil aus und fügen Sie es mit den folgenden Eingaben hinzu
    </div>
    `;
...
function loadBomTable(table, options={}) {
            ...
            if (any_pricing) {
                ...
                if (complete_pricing) {
                    html += makeIconBadge(
                        ...
                        'Stücklistenpreise sind vollständig',
                    );
                } else {
                    html += makeIconBadge(
    ...
    cols.push({
        ...
        formatter: function(value, row) {
            ...
            if (external_stock > 0) {
                text += makeIconBadge('fa-sitemap', `Externes Lager: ${external_stock}`);
            }
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (row.parent && row.parent != 'top-level-item') {
                        html += ` <em>(Von übergeordneter Stückliste geerbt)</em>`;
                    }
