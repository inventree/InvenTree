            ...
            },
            {
                ...
                formatter: function(value, row, index, field) {
                    ...
                    if (options.allow_edit || options.allow_delete) {
                        ...
                        if (options.allow_edit) {
                            html += makeCopyButton('button-duplicate', pk, 'Sor másolása');
                            html += makeEditButton('button-edit', pk, 'Sor szerkesztése');
                        }

                        if (options.allow_delete) {
                            html += makeDeleteButton('button-delete', pk, 'Sor törlése', );
                        }
                    }
