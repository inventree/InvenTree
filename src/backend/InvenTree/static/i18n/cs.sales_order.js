            ...
            if (!allocations || allocations.length == 0) {
                ...
                allocations.forEach(function(allocation) {
                    ...
                    if (allocation.serial) {
                        ...
                        stock = `Množství: ${allocation.quantity}`;
                    }
...
function loadSalesOrderShipmentTable(table, options={}) {
    ...
    $(table).inventreeTable({
        ...
        columns: [
            ...
            {
                field: 'delivery_date',
                title: 'Datum doručení',
                sortable: true,
                formatter: function(value, row) {
                    if (value) {
                        return renderDate(value);
                    } else {
                        return '<em>Neznámý</em>';
                    }
                }
            },
            {
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    var text = `Skladové položky ${row.item}`;
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row, index, field) {
                    ...
                    let text = `Množství: ${row.quantity}`;
            ...
            },
            {
                ...
                formatter: function(value, row, index, field) {
                    ...
                    if (row.shipment_date) {
                        ...
                        // Location specified
                        return renderLink(
                            row.location_detail.pathstring || 'Lokace',
