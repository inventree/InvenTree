...
function partStockLabel(part, options={}) {
    ...
    if (part.building) {
        elements.push(`Construction: ${part.building}`);
    }
                ...
                formatter: function(value, row) {
                    ...
                    if (row.supplier_part_detail && row.supplier_part_detail.pack_quantity_native != 1.0) {
                        ...
                        data += makeIconBadge(
                            ...
                            `Nombre de paquet: ${pq} - Total Quantity: ${total}`
                        );
                    }
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (value > 0 && row.supplier_part_detail && row.supplier_part_detail.pack_quantity_native != 1.0) {
                        let pq = row.supplier_part_detail.pack_quantity_native;
                        let total = value * pq;
                        data += `<span class='fas fa-info-circle icon-blue float-right' title='Nombre de paquet: ${pq} - Total Quantity: ${total}'></span>`;
                    }
...
function partGridTile(part) {
    ...
    if (part.building) {
        rows += `<tr><td><b>Construction</b></td><td>${part.building} ${units}</td></tr>`;
    }
