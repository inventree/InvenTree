    ...
    inventreeGet(`/api/company/part/${part}/`, {}, {
        success: function(data) {
            ...
            constructForm('/api/company/part/', {
                method: 'POST',
                fields: fields,
                title: 'Duplikovat dodavatele dílu',
                data: data,
...
function editSupplierPart(part, options={}) {
    ...
    constructForm(`/api/company/part/${part}/`, {
        fields: fields,
        title: options.title || 'Upravit dodavatele dílu',
        onSuccess: options.onSuccess
    });
}
    ...
    var columns = [
        ...
        },
        {
            ...
            formatter: function(value, row) {
                ...
                if (row.is_supplier) {
                    html += `<span title='Dodavatel' class='fas fa-building float-right'></span>`;
                }
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    html += makeEditButton('button-manufacturer-part-edit', pk, 'Upravit díl výrobce');
                    html += makeDeleteButton('button-manufacturer-part-delete', pk, 'Odstranit díl výrobce');
...
function loadSupplierPartTable(table, url, options) {
    ...
    setupFilterList('supplierpart', $(table), '#filter-list-supplier-part', {
        custom_actions: [
            {
                label: 'supplier-part',
                title: 'Akce týkající se dílu dodavatele',
                icon: 'fa-tools',
