            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (options.allow_edit) {
                        html += makeEditButton('btn-contact-edit', pk, 'Изменить контакт');
                    }

                    if (options.allow_delete) {
                        html += makeDeleteButton('btn-contact-delete', pk, 'Удалить Контакт');
                    }
    ...
    $(table).inventreeTable({
        ...
        columns: [
            ...
            },
            {
                ...
                title: 'Записи Курьера',
                sortable: false,
                switchable: true,
            },
            {
                field: 'internal_shipping_notes',
                title: 'Внутренние записи',
                sortable: false,
                switchable: true,
            },
            {
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (options.allow_edit) {
                        html += makeEditButton('btn-address-edit', pk, 'Редактировать адрес');
                    }

                    if (options.allow_delete) {
                        html += makeDeleteButton('btn-address-delete', pk, 'Удалить Адрес');
                    }
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (row.part_detail && row.part_detail.units) {
                        html += `<span class='fas fa-info-circle float-right' title='Базовая Единица: ${row.part_detail.units}'></span>`;
                    }
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    buttons += makeEditButton('button-price-break-edit', row.pk, 'Изменить разрыв цен');
