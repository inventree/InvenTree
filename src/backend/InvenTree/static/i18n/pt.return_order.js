...
function createReturnOrder(options={}) {
    ...
    constructForm('/api/order/ro/', {
        method: 'POST',
        fields: fields,
        title: 'Criar Pedido de Devolução',
...
function editReturnOrder(order_id, options={}) {
    ...
    constructForm(`/api/order/ro/${order_id}/`, {
        ...
        title: 'Editar Pedido de Devolução',
...
function issueReturnOrder(order_id, options={}) {
    ...
    constructForm(`/api/order/ro/${order_id}/issue/`, {
        method: 'POST',
        title: 'Emitir Pedido de Devolução',
        confirm: true,
        preFormContent: html,
        onSuccess: function(response) {
            handleFormSuccess(response, options);
...
function cancelReturnOrder(order_id, options={}) {
    ...
    Tem certeza que deseja cancelar este Pedido de Devolução?
    </div>`;
    ...
    constructForm(
        ...
        {
            method: 'POST',
            title: 'Cancelar Pedido de Devolução',
            confirm: true,
            preFormContent: html,
            onSuccess: function(response) {
                handleFormSuccess(response, options);
...
function completeReturnOrder(order_id, options={}) {
    ...
    constructForm(
        ...
        {
            method: 'POST',
            title: 'Completar Pedido de Devolução',
            confirm: true,
            preFormContent: html,
            onSuccess: function(response) {
                handleFormSuccess(response, options);
...
function loadReturnOrderTable(table, options={}) {
    ...
    $(table).inventreeTable({
        ...
        formatNoMatches: function() {
            return 'Nenhum pedido de devolução encontrado';
        },
...
function receiveReturnOrderItems(order_id, line_items, options={}) {
    ...
    constructForm(`/api/order/ro/${order_id}/receive/`, {
        ...
        title: 'Receber Itens do Pedido de Devolução',
                ...
                formatter: function(value, row) {
                    ...
                    if (options.allow_edit) {
                        ...
                        if (options.allow_receive && !row.received_date) {
                            buttons += makeIconButton('fa-sign-in-alt icon-green', 'button-line-receive', pk, 'Marcar item como recebido');
                        }
