        ...
        url,
        {
            ...
            preFormContent: function(opts) {
                ...
                <div class='alert alert-info alert-block'>
                    Are you sure you wish to place this order on hold?
                </div>`;
...
function createExtraLineItem(options={}) {
    ...
    constructForm(options.url, {
        fields: fields,
        method: 'POST',
        title: 'Zusätzliche Position hinzufügen',
        onSuccess: function(response) {
            if (options.table) {
            ...
            },
            {
                ...
                formatter: function(value, row, index, field) {
                    ...
                    if (options.allow_edit || options.allow_delete) {
                        ...
                        if (options.allow_edit) {
                            html += makeCopyButton('button-duplicate', pk, 'Postionen duplizieren');
                            html += makeEditButton('button-edit', pk, 'Position bearbeiten');
                        }

                        if (options.allow_delete) {
                            html += makeDeleteButton('button-delete', pk, 'Position löschen', );
                        }
                    }
