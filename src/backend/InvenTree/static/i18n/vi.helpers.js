...
function editButton(url, text='Sửa') {
...
function renderClipboard(s, prepend=false) {
    ...
    let clipString = `<span class="d-none d-xl-inline"><button class="btn clip-btn" type="button" data-bs-toggle='tooltip' title='sao chép đến bảng tạm'><em class="fas fa-copy"></em></button></span>`;
