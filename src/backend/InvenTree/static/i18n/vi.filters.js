...
function makeCustomActionGroup(action_group, table) {
    ...
    let title = action_group.title || 'Chức năng';
...
function makeBarcodeActions(barcode_actions, table) {
    ...
    let html = `
    <div class='btn-group' role='group'>
    <button id='barcode-actions' title='Chức năng mã vạch' class='btn btn-outline-secondary dropdown-toggle' type='button' data-bs-toggle='dropdown'>
...
function setupFilterList(tableKey, table, target, options={}) {
    ...
    if (report_button || labels_button) {
        let print_buttons = `
        <div class='btn-group' role='group'>
        <button id='printing-options' title='Chức năng in' class='btn btn-outline-secondary dropdown-toggle' type='button' data-bs-toggle='dropdown'>
