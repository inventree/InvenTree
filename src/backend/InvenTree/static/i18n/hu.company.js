...
function deleteSupplierParts(parts, options={}) {
    ...
    <tr>
        <th>Alkatrész</th>
        <th>SKU (leltári azonosító)</th>
        <th>Beszállító</th>
        <th>MPN (Gyártói cikkszám)</th>
    </tr>
    ${rows}
    </table>
    `;
...
function deleteAddress(addresses, options={}) {
    ...
    let html = `
    <div class='alert alert-block alert-danger'>
    Az összes kijelölt cím törlésre kerül
    </div>
    <table class='table table-striped table-condensed'>
    <tr>
        <th>Név</th>
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (options.allow_edit) {
                        html += makeEditButton('btn-address-edit', pk, 'Cím szerkesztése');
                    }

                    if (options.allow_delete) {
                        html += makeDeleteButton('btn-address-delete', pk, 'Cím törlése');
                    }
        ...
        custom_actions: [
            {
                ...
                title: 'Gyártói alkatrész műveletek',
                icon: 'fa-tools',
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (row.part_detail && row.part_detail.units) {
                        html += `<span class='fas fa-info-circle float-right' title='Egység: ${row.part_detail.units}'></span>`;
                    }
