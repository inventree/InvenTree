            ...
            },
            {
                ...
                formatter: function(value, row, index, field) {
                    ...
                    if (options.allow_edit || options.allow_delete) {
                        ...
                        if (options.allow_edit) {
                            html += makeCopyButton('button-duplicate', pk, 'Дублировать Строку');
                            html += makeEditButton('button-edit', pk, 'Редактировать строку');
                        }

                        if (options.allow_delete) {
                            html += makeDeleteButton('button-delete', pk, 'Удалить строку', );
                        }
                    }
