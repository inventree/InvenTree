...
function calculateTotalPrice(dataset, value_func, currency_func, options={}) {
    ...
    if (!rates) {
        ...
        return `<span class='icon-red fas fa-exclamation-circle' title='Erro ao buscar dados monetários'></span>`;
    }
...
function loadBomPricingChart(options={}) {
    ...
    table.inventreeTable({
        ...
        formatNoMatches: function() {
            return 'Nenhum dado da BOM disponível';
        },
    ...
    table.inventreeTable({
        ...
        onLoadSuccess: function(data) {
            ...
            chart = loadBarChart(chartElement, {
                ...
                datasets: [
                    {
                        label: 'Histórico de Preço de Venda',
                        data: graphValues,
                        backgroundColor: 'rgba(255, 206, 86, 0.2)',
                        borderColor: 'rgb(255, 206, 86)',
                        stepped: true,
...
function loadVariantPricingChart(options={}) {
    ...
    table.inventreeTable({
        ...
        showColumns: false,
        formatNoMatches: function() {
            return 'Nenhum dado de variante disponível';
        },
        onLoadSuccess: function(data) {
