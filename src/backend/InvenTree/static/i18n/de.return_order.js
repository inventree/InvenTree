...
function createReturnOrder(options={}) {
    ...
    constructForm('/api/order/ro/', {
        method: 'POST',
        fields: fields,
        title: 'Rücksendeauftrag erstellen',
...
function editReturnOrder(order_id, options={}) {
    ...
    constructForm(`/api/order/ro/${order_id}/`, {
        ...
        title: 'Rücksendeauftrag bearbeiten',
...
function cancelReturnOrder(order_id, options={}) {
    ...
    Soll der Rücksendeauftrag storniert werden?
    </div>`;
    ...
    constructForm(
        ...
        {
            method: 'POST',
            title: 'Rücksendeauftrag stornieren',
            confirm: true,
            preFormContent: html,
            onSuccess: function(response) {
                handleFormSuccess(response, options);
...
function completeReturnOrder(order_id, options={}) {
    ...
    constructForm(
        ...
        {
            method: 'POST',
            title: 'Rücksendeauftrag abschließen',
            confirm: true,
            preFormContent: html,
            onSuccess: function(response) {
                handleFormSuccess(response, options);
...
function loadReturnOrderTable(table, options={}) {
    ...
    $(table).inventreeTable({
        ...
        formatNoMatches: function() {
            return 'Kein Rücksendeauftrag gefunden';
        },
...
function receiveReturnOrderItems(order_id, line_items, options={}) {
    ...
    constructForm(`/api/order/ro/${order_id}/receive/`, {
        ...
        title: 'Rücksendeauftragspositionen erhalten',
                ...
                formatter: function(value, row) {
                    ...
                    if (options.allow_edit) {
                        ...
                        if (options.allow_receive && !row.received_date) {
                            buttons += makeIconButton('fa-sign-in-alt icon-green', 'button-line-receive', pk, 'Artikel als empfangen markieren');
                        }
