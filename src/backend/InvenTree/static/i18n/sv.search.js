...
function updateSearch() {
    ...
    if ((checkPermission('sales_order') || checkPermission('purchase_order')) && user_settings.SEARCH_PREVIEW_SHOW_COMPANIES) {
        ...
        addSearchQuery('company', 'Företag', filters);
    }
    ...
    <div class='alert alert-block alert-secondary'>
        <span class='fas fa-spinner fa-spin'></span> <em>Söker</em>
    </div>
    `);
            ...
            success: function(response) {
                ...
                if (any_results) {
                    ...
                    <div class='alert alert-block alert-warning'>
                        <span class='fas fa-exclamation-circle'></span> <em>Inga resultat</em>
                    </div>
                    `);
                }
            },
...
function addSearchResults(results, resultType, resultCount) {
    ...
    let resultText = resultCount == 1 ? 'resultat' : 'resultat';
