...
function createNewModal(options={}) {
    ...
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>Изпращане</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || 'Изпращане');
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || 'Изпращане';
