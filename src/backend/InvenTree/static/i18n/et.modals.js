...
function createNewModal(options={}) {
    ...
    if (!options.hideCloseButton) {
        buttons += `<button type='button' class='btn btn-secondary' id='modal-form-close' data-bs-dismiss='modal'>Tühista</button>`;
    }

    // Add in a "submit" button
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>Esita</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || 'Esita');
    modalSetCloseText(modal_name, options.closeText || 'Tühista');
...
function showQuestionDialog(title, content, options={}) {
    ...
    options.closeText = options.cancel_text || 'Tühista';
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || 'Esita';
    var close_text = options.close_text || 'Sulge';
