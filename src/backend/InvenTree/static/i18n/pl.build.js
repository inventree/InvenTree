    ...
    constructForm(`/api/build/${build_id}/finish/`, {
        ...
        preFormContent: function(opts) {
            ...
            if (ctx.allocated && ctx.remaining == 0 && ctx.incomplete == 0) {
                ...
                if (!ctx.allocated) {
                    html += `<div class='alert alert-block alert-warning'>Wymagany stan nie został w pełni przypisany</div>`;
                }
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (row.in_production && row.in_production > 0) {
                        icons += makeIconBadge('fa-tools icon-blue', `W produkcji: ${formatDecimal(row.in_production)}`);
                    }
