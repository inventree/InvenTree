...
function insertConfirmButton(options) {
    ...
    var message = options.confirmMessage || 'تأكيد';
            ...
            const content = `
                <div class="mb-1">
                    <div class="input-group mb-2">
                        <input class="form-control" type="text" id="${name}_tree_search" placeholder="ابحث ${options.actions[name].label}..." />
