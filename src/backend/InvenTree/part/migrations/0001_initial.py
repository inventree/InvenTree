        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'note',
                    models.CharField(
                        blank=True, help_text='BOM item notes', max_length=100
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text='Part variant or revision code',
                        max_length=32,
                    ),
                ),
                (
                    'description',
                    models.CharField(help_text='Part description', max_length=250),
                ),
                (
                    'keywords',
                    models.CharField(
                ...
                (
                    'active',
                    models.BooleanField(default=True, help_text='Is this part active?'),
                ),
                ('notes', models.TextField(blank=True)),
                (
                    'bom_checksum',
                    models.CharField(
                        blank=True, help_text='Stored BOM checksum', max_length=128
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'attachment',
                    models.FileField(
                        help_text='Select file to attach', upload_to=attach_file
                    ),
                ),
