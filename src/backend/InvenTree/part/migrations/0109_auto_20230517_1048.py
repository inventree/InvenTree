...
def update_parameter_values(apps, schema_editor):
    ...
    for parameter in PartParameter.objects.all():
        try:
            parameter.data_numeric = convert_to_numeric_value(
                parameter.data, parameter.template.units
            )
            parameter.save()
        except Exception:
            pass
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            update_template_units, reverse_code=migrations.RunPython.noop
        ),
        migrations.RunPython(
            update_parameter_values, reverse_code=migrations.RunPython.noop
        ),
    ]
