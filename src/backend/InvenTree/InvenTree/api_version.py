...
INVENTREE_API_TEXT = """
v350 -> 2025-06-14 : https://github.com/inventree/InvenTree/pull/9781
    - Mark "status" field as read-only in the StockItem API endpoint(s)
    - Require status field to be changed via the StockChangeStatusSerializer
