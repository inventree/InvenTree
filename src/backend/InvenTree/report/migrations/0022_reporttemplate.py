    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filters', models.CharField(blank=True, help_text='Report template query filters (comma-separated list of key=value pairs)', max_length=250, validators=[report.validators.validate_filters], verbose_name='Filters')),
            ],
            options={
                'abstract': False,
            },
