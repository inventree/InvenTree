...
class Migration(migrations.Migration):
    ...
    replaces = [('importer', '0001_initial'), ('importer', '0002_dataimportsession_field_overrides'), ('importer', '0003_dataimportsession_field_filters')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_file', models.FileField(help_text='Data file to import', upload_to='import', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['csv', 'xlsx', 'tsv', 'json']), importer.validators.validate_data_file], verbose_name='Data File')),
