...
export const menuItems: MenuLinkItem[] = [
  ...
  },
  {
    ...
    title: <Trans>Free for everyone</Trans>,
    description: <Trans>The fluid of Smeargle’s tail secretions changes</Trans>,
    detail: (
      <Trans>
  ...
  },
  {
    ...
    description: <Trans>Yanma is capable of seeing 360 degrees without</Trans>
  },
  {
    id: 'security',
    title: <Trans>Security</Trans>,
    description: (
      <Trans>The shell’s rounded shape and the grooves on its.</Trans>
    )
  },
  {
    id: 'analytics',
    ...
    description: (
      <Trans>This Pokémon uses its flying ability to quickly chase</Trans>
    )
  },
  {
    id: 'notifications',
    ...
    description: (
      <Trans>Combusken battles with the intensely hot flames it spews</Trans>
    )
  }
];
