...
export enum ApiEndpoints {
  ...
  purchase_order_status = 'order/po/status/',
  purchase_order_issue = 'order/po/:id/issue/',
  purchase_order_pending = 'order/po/:id/pending/',
  purchase_order_ready = 'order/po/:id/ready/',
  purchase_order_reject = 'order/po/:id/reject/',
  purchase_order_request_approval = 'order/po/:id/request_approval/',
  purchase_order_approval_allowed = 'order/po/:id/can_approve/',
  purchase_order_issue_allowed = 'order/po/:id/can_issue/',
