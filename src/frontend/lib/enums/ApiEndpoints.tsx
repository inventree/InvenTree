...
export enum ApiEndpoints {
  ...
  repair_order_list = 'build/repair/',
  repair_order_issue = 'build/repair/:id/issue/',
  repair_order_hold = 'build/repair/:id/hold/',
  repair_order_cancel = 'build/repair/:id/cancel/',
  repair_order_complete = 'build/repair/:id/complete/',
  repair_order_auto_allocate = 'build/repair/:id/auto-allocate/',
  repair_order_line_list = 'build/repair-line/',
  repair_order_allocation_list = 'build/repair-allocation/',
